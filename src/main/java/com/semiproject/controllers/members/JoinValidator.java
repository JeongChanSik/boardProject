...
import com.semiproject.commons.validators.MobileValidator;
import com.semiproject.commons.validators.PasswordValidator;
...
public class JoinValidator implements Validator, PasswordValidator, MobileValidator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        // 1. 아이디 중복 여부 체크 (이메일이 null이 아니고 이메일이 비어있지 않으면서 이메일이 repository 경로에 이메일이 있으면
